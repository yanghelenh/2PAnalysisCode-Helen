...
% testOptions_rigid = NoRMCorreSetParms('d1', size(testTrialData, 1), 'd2', size(testTrialData, 2), 'd3', size(testTrialData, 3), 'max_shift', 15, 'init_batch', 15, 'fr', 7);


%% perform motion correction
tic; [M1,shifts1,template1,options_rigid] = normcorre(Y,options_rigid); toc

% tic; [testM, testShifts, testTemplate, testOptions_rigid] = normcorre(testTrialData, testOptions_rigid); toc
...
% testOptions_nonRigid = NoRMCorreSetParms('d1', size(testTrialData, 1), 'd2', size(testTrialData, 2), 'd3', size(testTrialData, 3), ...
%                                       'max_shift', 15, 'init_batch', 15, 'fr', 7, 'max_dev', 5);
% 
% tic; [testM2, testShifts2, testTemplate2, testOptions_nonRigid] = normcorre(testTrialData, testOptions_nonRigid); toc
